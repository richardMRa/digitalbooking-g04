...
export default function Product(props) {
  ...
  }, [isFirstRender, hideGallery, navigate]);
      ...
      {isLoading ? <></> :
        <div >
          <div
            ...
            style={{ display: "none" }}
          >
            <div className="carousel-background" onClick={() => {
          ...
          <div className="img-container">
            <div className="actions">
              <i className="fa-solid fa-share-nodes" onClick={shareSocialMedia}></i>
              <svg
              ref={hearth}
            ...
            <div className="popup-container">
              <div className="popup" ref={popup}>
                ...
                <div className="content">
                  ...
                  <ul className="icons">
                    <FacebookShareButton url={window.location} quote={"Mira este incrible lugar!"}>
                      <a className="facebook-icon">
                        <i className="fab fa-facebook-f"></i>
                      </a>
                    </FacebookShareButton>
                    <PinterestShareButton url={window.location} media={images[0]}>
                      <a className="pinterest-icon">
                        <i className="fa-brands fa-pinterest"></i>
                      </a>
                    </PinterestShareButton>
                    <TelegramShareButton url={window.location} title={"Mira este incrible lugar!"}>
                      <a className="telegram-icon">
                        <i className="fab fa-telegram-plane"></i>
                      </a>
                    </TelegramShareButton>
                    <WhatsappShareButton url={window.location} title={"Mira este incrible lugar!"} separator=":: ">
                      <a className="whatsapp-icon">
                        <i className="fab fa-whatsapp"></i>
                      </a>
                    </WhatsappShareButton>
                    <TwitterShareButton url={window.location} title={"Mira este incrible lugar!"}>
          ...
          <div className="map-container">
            ...
            <div className="map">
              <NewMap city={data.city.name + ',' + data.address} cardInfo={data} />
            </div>
          </div>
